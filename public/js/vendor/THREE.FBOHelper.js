  ...
  class FBOHelper {
    constructor (renderer) {
      ...
      this.grid.addEventListener('wheel', e => {
        ...
        this.grid.style.transform = `translate3d(-50%, -50%, 0 ) scale(${this
          .camera.zoom},${this.camera.zoom}) translate3d(${this
          .offsetX}px,${this.offsetY}px,0) `
        this.label.style.transform = `scale(${1 / this.camera.zoom},${1 /
          this.camera.zoom})`
        this.hotspot.style.transform = `scale(${1 / this.camera.zoom},${1 /
          this.camera.zoom})`
    ...
    attach (fbo, name, formatter) {
      ...
      li.addEventListener('click', e => {
        ...
        if (quad.visible) {
          ...
          this.info.innerHTML = `Width: ${fbo.width} Height: ${fbo.height}<br/>Format: ${formats[
            fbo.texture ? fbo.texture.format : fbo.format
